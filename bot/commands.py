...
[종목 선정 방식]
• 장 초반 (09:00~09:45): 급등 Top30 → 거래대금+등락률 스코어링 / 2분 갱신
• 장 중반 (09:45~14:40): 거래량급증 Top50 → 거래량급증률+등락률+RSI+외인기관 스코어링 / 10분 갱신
• 장 후반 (14:40~15:30): 기존 선정 종목 유지 (신규 선정 없음)
※ ETF·ETN·레버리지·인버스·스팩 자동 제외

[매매 전략]
• 공통 청산: 데드크로스(MA{chart_short} < MA{chart_long}) AND RSI < 45
• 공통 손절: 수익률 ≤ slr 즉시 매도
• 조기 손절: 진입 3분 이내 수익률 < -1.2% 시 즉시 매도
• 트레일링: 최고 수익(peak) 기준 동적 4단계
