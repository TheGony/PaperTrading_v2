...
[종목 선정 방식]
■ ORB 풀 (09:01 1차 + 09:03 2차 갱신, 이후 고정)
...
■ 모멘텀 풀 (ORB와 완전 분리, 점수 기반 선택적 교체)
  ...
  장 중반 (09:45~14:40): 거래량급증 Top50 + 외인기관 보너스 / 5분 갱신
  장 후반 (14:40~15:30): 중반과 동일 / 5분 갱신
...
■ 모멘텀 전략
  공통 진입 조건:
    ...
    추격방지: 초반 +2% / 중반·후반 +1% 초과 금지
    최근 20봉 고점 1% 이내 진입 금지
    과열 종목(등락률 > 20%) 진입 금지
  ...
  [장 초반] 직전 3봉 고점 돌파 확인(2.5초)
            거래량 > 직전봉×1.5 / 현재가 > 시가×0.98 / RSI 40~70
            최대 5회 / 손절 -2% / 트레일링 2%

  [장 중반] 직전 5봉 고점 돌파 확인(4초)
            거래량 > 직전봉×1.3 / RSI 45~65 + RSI 상승 중
